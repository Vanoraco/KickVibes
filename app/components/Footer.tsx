              ...
              <div className="enhanced-footer-main">
                ...
                <div className="enhanced-footer-brand">
                  ...
                  <p className="enhanced-footer-description">
                    {settings.footerDescription || settings.siteDescription || 'Discover the latest and greatest in premium sneaker fashion. From limited editions to everyday essentials, we bring you the best kicks from top brands worldwide.'}
                  </p>
                  <div className="enhanced-footer-social">
                    {settings.socialInstagram && (
                      <a href={settings.socialInstagram} className="enhanced-footer-social-link" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                    ...
                    {settings.socialTwitter && (
                      <a href={settings.socialTwitter} className="enhanced-footer-social-link" aria-label="Twitter" target="_blank" rel="noopener noreferrer">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    {settings.socialFacebook && (
                      <a href={settings.socialFacebook} className="enhanced-footer-social-link" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    {settings.socialYoutube && (
                      <a href={settings.socialYoutube} className="enhanced-footer-social-link" aria-label="YouTube" target="_blank" rel="noopener noreferrer">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    {settings.socialTiktok && (
                      <a href={settings.socialTiktok} className="enhanced-footer-social-link" aria-label="TikTok" target="_blank" rel="noopener noreferrer">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="enhanced-footer-bottom">
                <div className="enhanced-footer-bottom-content">
                  ...
                  <div className="enhanced-footer-copyright">
                    <p>&copy; {new Date().getFullYear()} {settings.copyrightText || `${settings.siteName}. All rights reserved.`}</p>
                  </div>
                </div>
              </div>
            </div>
